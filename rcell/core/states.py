...
class SimulatorState(object):
    ...
    def add_structure(self, structure):
        ...
        if self.states is not None:
            raise core_exceptions.StateVectorAlreadyGenerated(
                'Cannot add structures after state vector has been generated.')
    ...
    def add_group(self, state_group):
        ...
        if self.states is not None:
            raise core_exceptions.StateVectorAlreadyGenerated(
                'Cannot add state groups after state vector has been generated.')
    ...
    def build_state_vector(self):
        ...
        Length of vector is specified by the state_len property.
        Once this is generated cannot add new structures or state groups.
        """
        if self.states is not None:
            raise core_exceptions.StateVectorAlreadyGenerated(
                'The state vector has already been generated.')
...
class StateGroup(object):
    """
    Define a continuous subset of the global architecture state vector.

    Also provide some logical mapping to more useful keys.
    """
    ...
    def extract_state(self, state_vector):
        """
        Extract the relevant portion of the state vector from the global state vector.
        """
